function productItem ({key, name, urlPath, typeName, desc, price}) {
    const template =`
            ...
            <div class="product-top">
                <div class="buttons">
                    ...
                    <a href="#" id="edit" data-key="${key}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="30" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
